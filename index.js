...
const BOT_URL = `https://cherrydeals-bot.onrender.com`;
...
async function startBot() {
    try {
        ...
        // Простой health check каждые 30 секунд
        setInterval(() => {
            console.log('❤️ Bot is alive...');
        }, 30000);
...
console.log('🎯 Bot configuration completed');
